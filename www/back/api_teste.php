...
//var_dump($_SERVER['REMOTE_ADDR'],$_SERVER['PATH_INFO']); die();
// var_dump($_SERVER['REQUEST_METHOD'],$_SERVER['PATH_INFO']); die();

// if ($_SERVER['REMOTE_ADDR']!='184.107.54.145') die('se liga, seu ip foi capturado... ->' . $_SERVER['REMOTE_ADDR']);
...
$api = new PHP_CRUD_API(array(
	'dbengine'=>'MySQL',
	'hostname'=>'servicosvilaverde.com.br',
	'username'=>'waisoc_servicos',
	'password'=>'xH69FFTocsKn',
	'database'=>'waisoc_teste',
	'charset'=>'utf8'
));
$api->executeCommand();
